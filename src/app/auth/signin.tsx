...
export default function SignInScreen() {
    ...
    return (
        <View className='flex-1  p-6'>
            <FeedHeader />
            <Text className='text-start text-4xl font-semibold py-6'>Sign In</Text>
            <View className=''>
                <UserAuthForm className="w-full" />
                <View className="flex items-center mt-4">
                    <Text onPress={() => router.replace("/auth/signup")} className="text-gray-500">Don't have an account? <Text className="text-blue-700 font-bold underline"> Sign Up</Text>
                    </Text>
                </View>
